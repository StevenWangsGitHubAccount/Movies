  ...
  it('should display the top 10 movies of the genre the user clicks', (async () => {
      ...
      try {
          ...
          for (const genre in TOP_10) {
            ...
            await button.click();
            await driver.sleep(2000); // Wait for top movies to load.
  ...
  it('should return the correct movies for a given decade', (async () => {
      ...
      try {
          for (const decade of Object.keys(BEST_GENRES)) {
            ...
            await driver.sleep(3000); // Wait for decades to load.
            const dropdown = await driver.findElement(By.id('decadesDropdown'));
            await dropdown.click();
            await driver.sleep(3000); // Wait for options to populate
